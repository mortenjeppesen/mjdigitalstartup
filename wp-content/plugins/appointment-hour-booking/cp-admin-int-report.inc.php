...
<div class="ahb-statssection-container" style="background:#f6f6f6;float:left;width:48%;">
	...
	<div class="ahb-statssection">
        ...
        <div style="padding-right:5px;padding-left:5px;color:#888888;">* <?php _e('Submissions per day in the selected date range.','appointment-hour-booking'); ?><br />&nbsp;&nbsp; <?php _e('Days from','appointment-hour-booking'); ?> <?php echo $date_start; ?> to <?php echo $date_end; ?>.</div>
        <div class="clear"></div>
	</div>
</div>
	...
	<div class="ahb-statssection">
        ...
        <div style="width:100%;padding:0;background:white;border:1px solid #e6e6e6;">
         <div style="padding:10px;background:#ECECEC;color:#21759B;font-weight: bold;">
           <?php _e('Report of values for','appointment-hour-booking'); ?>: <em><?php echo $this->get_form_field_label($_GET["field"],$form); ?></em>
         </div>
        ...
        ?>
         ...
         <div style="padding-right:5px;padding-left:5px;margin-bottom:20px;color:#888888;">&nbsp;&nbsp;* <?php _e('Number of times that appears each value. Percent in relation to the total of submissions.','appointment-hour-booking'); ?><br />&nbsp;&nbsp;&nbsp;&nbsp; <?php _e('Date range from','appointment-hour-booking'); ?> <?php echo $date_start; ?> <?php _e('to','appointment-hour-booking'); ?> <?php echo $date_end; ?>.</div>
        </div>
