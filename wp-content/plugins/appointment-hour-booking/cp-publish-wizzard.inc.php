...
<div class="ahb-section-container">
	<div class="ahb-section ahb-section-active" data-step="1">
        ...
        <div style="clear:both"></div>
        <button class="button button-primary cpmvcontainer" type="button" id="nextBtn" onclick="window.open('?page=cp_apphourbooking&cal=<?php echo $this->get_param("cpapphourbk_id"); ?>');"><?php _e('Edit the booking form settings and calendar availability','appointment-hour-booking'); ?></button>
        <div style="clear:both"></div>
    </div>
</div>
<div style="clear:both"></div>
