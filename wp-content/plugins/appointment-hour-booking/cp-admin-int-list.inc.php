...
<?php } ?> 
                             <input style="margin-bottom:5px;" class="button" type="button" name="calmessages_<?php echo $item->id; ?>" value="<?php _e('Booking Orders','appointment-hour-booking'); ?>" onclick="cp_viewMessages(<?php echo $item->id; ?>);" />
                             <input style="margin-bottom:5px;" class="button" type="button" name="calschedule_<?php echo $item->id; ?>" value="<?php _e('Schedule','appointment-hour-booking'); ?>" onclick="cp_viewSchedule(<?php echo $item->id; ?>);" />
                             <input style="margin-bottom:5px;" class="button" type="button" name="caladdbk_<?php echo $item->id; ?>" value="<?php _e('Add Booking','appointment-hour-booking'); ?>" onclick="cp_addbk(<?php echo $item->id; ?>);" />
